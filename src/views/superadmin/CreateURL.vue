<template>
  <title>Create Short URL | Elfrique - Super Admin</title>
  <dash-header />
    ...
    <div class="container short-url-dash">
      <div class="row justify-content-center">
        <div class="col-lg-7">
          ...
          <div class="box-note">
            <p>
              You can shorten urls here , there is option for you to enter an
              alias(short-prefix) you wish to use, your shortened link will be
              like <strong>https://elfrique.com/s/youralias</strong> that will
              be set for you if its available, if its not available you will be
              notified that its not available and you wil have to choose another
              one, if you leave the url prefix empty then a prefix will be
              automatically created for you.
            </p>
          </div>
          <div class="created-url-here mt-5" v-if="successful">
            <div
              v-if="clipMessage"
          ...
          <form name="form" @submit.prevent="createURL">
            <div class="row">
              ...
              <div class="col-lg-12">
                <label for="Elfrique Website Link Original URL"
                  >Elfrique Website Link Original URL</label
                >
                <input
                  v-model="url.longUrl"
                  type="url"
  ...
  export default {
    ...
    methods: {
      ...
      createURL() {
        ...
        VendorService.createUrl(urlForm).then(
          (response) => {
