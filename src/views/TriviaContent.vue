        ...
        <div class="row">
          ...
          <div class="col-md-4 col-lg-4">
            <div class="text-title-area">
              ...
              <div class="details-header">
                <h5>Price</h5>
                <p>
                  <i class="bi bi-credit-card-fill"></i> : {{ trivia.type }}
                </p>
                <h5>Duration</h5>
                <p>
                  <i class="bi bi-alarm"></i> : {{ trivia.duration }} Minutes
                </p>
              </div>
          ...
          <div class="col-lg-4 form-area" v-if="paymentForm">
            <div class="contestantPaySection">
              <h4>
                You are about to pay. There would be no refund or reversal if
                you choose a wrong form.
              </h4>
              <hr />
              ...
              <div>
                ...
                <p v-if="toRate">
                  {{ currency_symbol }} {{ (amount / toRate).toFixed(2) }}
                </p>
              </div>
              <h5 class="mt-2" v-if="currency_symbol === 'NGN'">
            ...
            <div v-else class="mt-n3">
              ...
              >
                <button @click="PayStack(trivia.id)" :disabled="loading">
                  Pay Now – Local
                </button>
              </div>
              <div
                    ...
                    <form @submit.prevent="submitPlayer">
                      <div class="row">
                        <div class="col-lg-12">
                          <h1>Get Trivia</h1>
                          <h6>
                            Enter the following details to access trivia
                            question
                          </h6>
                        </div>
