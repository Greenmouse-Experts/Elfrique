<template>
  <title>Edit Event | Elfrique</title>
  <dash-header />
  ...
  <main id="main" class="main">
    ...
    <div class="container start-voting-div create-event-div">
      <div class="row justify-content-center">
        <form name="form" @submit.prevent="updateEvents">
          <div class="row justify-content-center">
              ...
              <div class="row">
                ...
                <div class="col-lg-12 mt-4">
                  ...
                  <small class="text-danger font-weight-bold"
                    >(only .jpg, .jpeg, .png, .jfif or .webp format)
                  </small>
                </div>
                <!--Event Description-->
                <div class="col-lg-12 mt-4">
                ...
                <div class="col-lg-12 mt-4">
                  ...
                  <input
                    v-model="eventContent.organizer"
                    class="input"
                    type="text"
                ...
                <div class="col-lg-12 mt-4">
                  ...
                  <select
                    v-model="eventContent.paymentgateway"
                    name="gateway"
                    id="gateway"
                    required
                  >
              ...
              <div class="row">
                ...
                <div class="col-lg-12 mt-2">
                  ...
                  >
                    ...
                    <option value="11">Conferences</option>
                    <option value="12">Networking</option>
                    <option value="13">A.G.M's</option>
                    <option value="14">Exhibitions</option>
                    <option value="15">Trainings</option>
                    <option value="16">Classes</option>
                    <option value="17">Government</option>
                    <option value="18">NGO's</option>
                  </select>
                </div>
              </div>
            </div>
...
<script>
  ...
  export default {
    ...
    created() {
      if (!this.loggedIn) {
        ...
        EventService.getSingleEvent(this.$route.params.id).then((res) => {
            this.eventContent.title = res.data.events.title;
            this.eventContent.category = res.data.events.category;
            this.eventContent.city = res.data.events.city;
            this.eventContent.country = res.data.events.country;
            this.eventContent.state = res.data.events.state;
            this.eventContent.description = res.data.events.description;
            this.eventContent.enddate = res.data.events.enddate;
            this.eventContent.organizer = res.data.events.organisation;
            this.eventContent.startdate = res.data.events.startdate;
            this.eventContent.venue = res.data.events.venue;
            this.eventContent.paymentgateway = res.data.events.paymentgateway;
            this.eventContent.timezone = res.data.events.timezone;
            this.eventContent.id = res.data.events.id;
      })
    },

    methods: {
        resetDate(date, index) {
            var today = new Date(date.target.value).toISOString().slice(0, 16);
            document.getElementsByName("date")[index+1].min = today;
      ...
      updateEvents() {
        ...
        EventService.updateEvent(this.eventContent.id, formData).then(
          (response) => {
    ...
    mounted() {
      ...
      externalScriptQuill.setAttribute(
        "src",
        "https://cdn.statically.io/gh/NathTimi/scripts/main/quill.min.js"
      );
      externalScriptRich.setAttribute(
        "src",
        "https://cdn.statically.io/gh/NathTimi/scripts/main/rich-text.js"
      );
      ...
      for (var i = 0; i < document.getElementsByName("date").length; i++) {
        document.getElementsByName("date")[i].min = today;
      }
    },
  };
</script>
