            ...
            <div class="col-lg-11 start-voting-inner-div">
              <div class="row">
                ...
                <div class="col-lg-12 mt-4" v-if="paid">
                  ...
                  <select
                    v-model="Content.paymentgateway"
                    name="gateway"
                    id="gateway"
                    required
                  >
  ...
  export default {
    ...
    methods: {
      ...
      createForm() {
        ...
        EventService.createForm(formData).then(
          (response) => {
            this.message =
              "Form Details Added Successfully, Continue to build your form";
